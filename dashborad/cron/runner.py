...
#                 "hostname": 'bdl',
#                 "username": "ubuntu",
#                # "password": "a8GWxQ0HhgnYoU0y",
#         },
#     ]
#     assets = [
#         {
#                # 'private_key_file': '/Users/xieyifan/Documents/keys/newjump',
#                 "ip": "192.168.1.2",
#                 "port": 22,
#                 "username": "wsbg",
#                 "password": "ws2017",
#         },
#     ]
#     task_tuple = (('shell', 'crontab -l'),)
#     hoc = AdHocRunner(hosts=assets)
#     # nhoc.results_callback = CommandResultCallback()
#     ret = hoc.run(task_tuple)
#     return ret
#     #
#     # play = PlayBookRunner(assets, playbook_path='/tmp/xx.yml')
#     # """
#     # # /tmp/some.yml
#     # ---
...
# print(a)
# print(type(a))
# print(a.get('contacted').get('bdl')[0].get('stdout'))
